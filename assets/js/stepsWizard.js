...
class Wizard {
  ...
  handleNextStepButton() {
    if (this.currentStep === this.stepsQuantity - 1) {
      ...
      this.nextControl.innerHTML = "Save & Continue"
  ...
  addControls(previousControl, nextControl, nextControlTop) {
    this.previousControl = previousControl
    this.nextControl = nextControl
    this.nextControlTop = nextControlTop
    this.previousControlMoveStepMethod = this.moveStep.bind(this, -1)
    this.nextControlMoveStepMethod = this.moveStep.bind(this, 1)
    this.nextControlTopMoveStepMethod = this.moveStep.bind(this, 1)

    previousControl.addEventListener("click", this.previousControlMoveStepMethod)
    nextControl.addEventListener("click", this.nextControlMoveStepMethod)
    nextControlTop.addEventListener("click", this.nextControlTopMoveStepMethod)
...
let buttonNextTop = document.querySelector(".next-top")
let buttonPrevious = document.querySelector(".previous")

wizard.addControls(buttonPrevious, buttonNext, buttonNextTop)
