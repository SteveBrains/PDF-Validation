...
define('TOKEN', '597dec4bf3826ca633b6f5ba6d9334c9');
define('USERKEY', '597dec4bf3826ca633b6f5ba6d9334c9');
define('LOGIN', '721f6638fb484690528dad6d71d72fcd');

$base_url = $_SERVER['HTTP_HOST'];

if ($base_url == "patna.com") {
	define('BASE_PATH', '//patna.com');
} else {
	define('BASE_PATH', 'https://college.tnhealthskills.ac.in');
}
