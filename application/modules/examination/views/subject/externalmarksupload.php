        ...
        <div class="panel-heading" role="tab" id="headingOne">
          <h4 class="panel-title">
            <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
              File Upload <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/External_Marks_Upload.xlsx" class="btn btn-link"><button type="button" class="btn btn-primary">Download Template</button></a>
            </a>
          </h4>
        </div>
