...
<body>
  <div class="main-container">
    ...
    <div class="field-border">
      <span>Name of the Centre: <u>
          <?php echo $candidate->trainingCenter; ?>
        </u></span>
    </div>
    <div class="field-border">
      <span>Student's Name: <u>
          <?php echo $candidate->name; ?>
        </u></span>
    </div>
    <div class="field-border">
      <span>Register No: <u>
          <?php echo $candidate->registration_number; ?>
        </u></span>
    </div>
    <div class="field-border" style="margin-bottom: 0px;">
      <span>Father's/Mother's Name: <u>
          <?php echo $candidate->father_name; ?>
        </u></span>
    </div>
    <div class="flex-row">
      <div class="field-border">
      ...
      <table>
        ...
        foreach ($subjectList as $row) { ?>
          <tr>
            ...
            <td>
              <?php echo $row->internal_max; ?>
            </td>
            <td>
              <?php echo $row->external_max; ?>
            </td>
            <td>
            ...
            <td>
              <?php echo ($row->total_marks > ($row->internal_min + $row->external_min)) ? "Pass" : "Fail"; ?>
            </td>
          </tr>
          <?php
        ...
        <tr>
          ...
          <td style="font-weight: bold">
            <?php echo $internal_max_total; ?>
          </td>
          <td style="font-weight: bold">
            <?php echo $external_max_total; ?>
          </td>
          <td style="font-weight: bold">
            <?php echo $internal_total; ?>
          </td>
          <td style="font-weight: bold">
            <?php echo $external_total; ?>
          </td>
          <td style="font-weight: bold">
            <?php echo $external_total + $internal_total; ?>
          </td>
    ...
    <div class="field-border">
      <span style="color: #00a0e3;">Total Marks in Words:</span>
      <?php echo inwords($external_total + $internal_total); ?>
    </div>
    <div class="field-border">
    ...
    <div class="sign-block">
      ...
      <div>
        <img src="<?php echo BASE_PATH; ?>/assets/resources/qr.png">
      </div>
      <div>
