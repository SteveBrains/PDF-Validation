  ...
  <div class="main-container clearfix">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-4">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8">
                        <select name="course_id" id="course_id" class="form-control" onchange="getCandidatesById(this.value)">
                          <option value="">Select</option>
                          <?php
                          if (!empty($courseList)) {
    ...
    <div class="panel-group advanced-search" id="accordion" role="tablist" aria-multiselectable="true">
      <div class="panel panel-default">
        ...
        <form action="promotion" method="post" id="searchForm" enctype="multipart/form-data">
          <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
            <div class="panel-body">
              <div class="form-horizontal">
                <div class="row">
...
<script>
  ...
  var candidate_id = "<?php echo ($candidate_id > 0) ? $candidate_id : 0; ?>";
  ...
  function getCandidatesById(id) {
    getSemestersById(id);
    var tcid = $('#training_center_id').val();
    if (id != '') {
      $.ajax('/placement/candidate/getCandidatesById', {
        type: 'POST',
        data: {
          course_id: id,
          tcid: tcid,
