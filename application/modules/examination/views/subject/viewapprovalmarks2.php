...
<div class="container-fluid page-wrapper">
  ...
  <div class="main-container clearfix">
            ...
            if (!empty($barcodeList)) {
              ...
              foreach ($barcodeList as $record) {
                ...
                <tr>
                  ...
                  <td>
                    <?php echo $record->centre; ?>
                  </td>
                  <td>
                    <?php echo $record->booklet_number; ?>
                  </td>
                  <td>
                    <?php echo $record->barcode; ?>
                  </td>
                  <td>
                    <?php echo $record->internal_marks; ?>
                  </td>
                  <td>
                    <?php echo $record->external_marks; ?>
                  </td>
                  <td>
                    <?php echo $record->packet_no; ?>
                  </td>
                  <td>
                    <?php echo $record->packet_sl_no; ?>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo 'log/' . $record->student_id; ?>" title="Edit">View</a>
                  </td>
                  <td class="text-center">
                    <a href="<?php echo 'markscard1/' . $record->student_id; ?>" title="Edit">Generate</a>
                  </td>
                </tr>
                <?php
                $i++;
    ...
    <form action="handleVerifyUpload" method="post" enctype="multipart/form-data">
