<div class="container-fluid page-wrapper">
    <div class="main-container clearfix">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" autocomplete="off" required value="<?php echo $batch->name; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Code<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="code" name="code" autocomplete="off" value="<?php echo $batch->code; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="training_center_id" id="training_center_id" class="form-control" onchange="getCoursesById(this.value)">
                                ...
                                if (!empty($tcList)) {
                                    foreach ($tcList as $record) { ?>
                                        <option value="<?php echo $record->Id;  ?>" <?php if ($record->Id == $batch->training_center_id) {
                                                                                        echo "selected";
                                                                                    } ?>>
                            ...
                            <select name="scheme_id" id="scheme_id" class="form-control">
                                ...
                                if (!empty($schemeList)) {
                                    foreach ($schemeList as $record) { ?>
                                        <option value="<?php echo $record->Id;  ?>"  <?php if ($record->Id == $batch->scheme_id) {
                                                                                        echo "selected";
                                                                                    } ?>>
                                            <?php echo $record->name; ?>
                                        </option>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="start_date" name="start_date" autocomplete="off" value="<?php echo $batch->start_date; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>End Date<span class='error-text'>*</span></label>
                            <input type="date" class="form-control" id="end_date" name="end_date" autocomplete="off" value="<?php echo $batch->end_date; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status" value="Active" <?php if ($batch->status == 'Active') {
                                                                                                    echo "checked=checked";
                                                                                                }; ?>><span class="check-radio"></span> Active
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status" value="Inactive" <?php if ($batch->status == 'Inactive') {
                                                                                                    echo "checked=checked";
                                                                                                }; ?>>
        ...
        <script>
            var training_center_id = "<?php echo $batch->training_center_id ?>";
            var course_id = "<?php echo $batch->course_id ?>";
