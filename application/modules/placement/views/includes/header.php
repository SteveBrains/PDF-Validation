...
<body>
  <header class="navbar navbar-default navbar-fixed-top main-header">
    <div class="container-fluid">
      ...
      <?php if ($_SESSION['role'] != 4 && $_SESSION['role'] != 7 && $_SESSION['role'] != 10 && $_SESSION['role'] != 6 && $_SESSION['role'] != 7 && $_SESSION['role'] != 11) { ?>
        <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav main-nav">
            <li class="active"><a href="/placement/trainingcenter/list">Placement</a></li>
            <li><a href="/examination/subject/list">Examination</a></li>
            <li><a href="/shortterm/scheme/list">Short Term</a></li>
            <li><a href="/mediumterm/scheme/list">Medium Term</a></li>
      ...
      <?php } else if ($_SESSION['role'] == 10) { ?>
        <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav main-nav">
            <li class="active"><a href="/placement/staffentry/list">Placement</a></li>
          </ul>
        </nav>
      <?php } else if ($_SESSION['role'] == 11) { ?>
        <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav main-nav">
            <li class="active"><a href="/placement/candidate/listall">Placement</a></li>
          </ul>
        </nav>
      <?php } else { ?>
        <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <ul class="nav navbar-nav main-nav">
            <li class="active"><a href="/placement/jobdescription/list">Placement</a></li>
          </ul>
        </nav>
      <?php } ?>
    </div>
