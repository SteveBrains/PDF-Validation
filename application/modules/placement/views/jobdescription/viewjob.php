        ...
        <form id="form_main" action="" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="title" name="title" autocomplete="off" value="<?php echo $jobdescription->title; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Code<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="code" name="code" autocomplete="off" value="<?php echo $jobdescription->code; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Type<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="type" name="type" autocomplete="off" value="<?php echo $jobdescription->type; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Skills<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="skills" name="skills" autocomplete="off" value="<?php echo $jobdescription->skills; ?>" placeholder="Eg: communication,project management" readonly>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="openings" name="openings" autocomplete="off" value="<?php echo $jobdescription->openings; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Minimum Qualification <span class='error-text'>*</span></label>
                            <select name="qualification" id="qualification" class="form-control" readonly>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="me_year" name="me_year" autocomplete="off" value="<?php echo $jobdescription->me_year; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>BE Percentage<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="be_cutoff" name="be_cutoff" autocomplete="off" value="<?php echo $jobdescription->be_cutoff; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>BE Passout Year<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="be_year" name="be_year" autocomplete="off" value="<?php echo $jobdescription->be_year; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>PUC Percentage<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="puc_cutoff" name="puc_cutoff" autocomplete="off" value="<?php echo $jobdescription->puc_cutoff; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>PUC Passout Year<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="puc_year" name="puc_year" autocomplete="off" value="<?php echo $jobdescription->puc_year; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>SSLC Percentage<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="sslc_cutoff" name="sslc_cutoff" autocomplete="off" value="<?php echo $jobdescription->sslc_cutoff; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>SSLC Passout Year<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="sslc_year" name="sslc_year" autocomplete="off" value="<?php echo $jobdescription->sslc_year; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Suggestions<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="suggestions" name="suggestions" autocomplete="off" value="<?php echo $jobdescription->suggestions; ?>" placeholder="Suggested text books to refer" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Test Location<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="test_location" name="test_location" autocomplete="off" value="<?php echo $jobdescription->test_location; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="aptitude" name="aptitude" autocomplete="off" value="<?php echo $jobdescription->aptitude; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Written Test(Technical)<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="technical" name="technical" autocomplete="off" value="<?php echo $jobdescription->technical; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Technical Interview<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="technical_interview" name="technical_interview" autocomplete="off" value="<?php echo $jobdescription->technical_interview; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>General HR Interview<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="hr_interview" name="hr_interview" autocomplete="off" value="<?php echo $jobdescription->hr_interview; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Monthly stipend during probabation<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="stipend" name="stipend" autocomplete="off" value="<?php echo $jobdescription->stipend; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Monthly salary after confirmation of service<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="salary" name="salary" autocomplete="off" value="<?php echo $jobdescription->salary; ?>" readonly>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status" value="Inactive" <?php if ($jobdescription->status == 'Inactive') {
                                                                                                    echo "checked=checked";
                                                                                                }; ?> disabled><span class="check-radio"></span> Inactive
                            </label>
                        </div>
                    </div>
                </div>
            ...
            <div class="button-block clearfix">
                <div class="bttn-group">
                    <a href="../approve/<?php echo $jobdescription->Id;?>"><button type="button" class="btn btn-primary btn-lg">Approve</button></a>
                    <a href="../reject/<?php echo $jobdescription->Id;?>"><button type="button" class="btn btn-primary btn-lg" style="background-color: red;;">Reject</button></a>
                    <a href="../approval" class="btn btn-link">Cancel</a>
                </div>
            </div>
