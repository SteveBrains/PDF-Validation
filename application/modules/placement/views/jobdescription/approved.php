    ...
    <div class="row">
      <div class="col-sm-12">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">Tag Resumes</li>
        </ol>
      </div>
    </div>
      ...
      <table class="table" id="list-table">
        <thead>
          <tr>
            ...
            <th>Status</th>
            <th> Tag</th>
            <th> Tagged Resumes</th>
            <th> View</th>
            <th> Submit for Shortlist</th>
          </tr>
        </thead>
        <tbody>
          <?php
          ...
          ?>
              <tr>
                ...
                <td>
                  <a href="<?php echo 'tagsubmit/' . $record->Id; ?>" title="Tag"><span class="glyphicon glyphicon-eye" aria-hidden="true"></span>Submit</a>
                </td>
