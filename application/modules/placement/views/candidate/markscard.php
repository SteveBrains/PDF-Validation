    ...
    <div class="main-container clearfix">
        ...
        <div class="row">
            <div class="col-sm-12">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Marks Card</li>
                </ol>
            </div>
        </div>
        <form id="form_main" action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-container">
                <h4 class="form-group-title">Marks Card Details</h4>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="markscard" name="markscard" autocomplete="off">
                        </div>
                    </div>
                </div>
            </div>
