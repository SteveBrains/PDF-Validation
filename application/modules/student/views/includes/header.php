...
<head>
  ...
  <link rel="stylesheet" href="<?php echo BASE_PATH; ?>/assets/css/jquery.steps.css" />
    ...
    <div class="container-fluid">
      <div class="clearfix">
        ...
        <ul class="nav navbar-nav navbar-right top-nav">
          <li>Welcome <a> <?php echo $_SESSION['name']; ?> </a></li>
          <li><a href="/index/logout">Logout</a></li>
        </ul>
      </div>
      <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
        <ul class="nav navbar-nav main-nav">
          <li class="active"><a href="/student/index/profile">Student</a></li>
        </ul>
      </nav>
    </div>
  </header>
