...
<div class="container-fluid page-wrapper">
    <div class="main-container clearfix">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="caste" id="caste" value="OC" <?php if ($candidate->caste == 'OC') {
                                                                                            echo "checked=checked";
                                                                                        }; ?>><span class="check-radio"></span> OC
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="caste" id="caste" value="BC" <?php if ($candidate->caste == 'BC') {
                                                                                            echo "checked=checked";
                                                                                        }; ?>><span class="check-radio"></span> BC
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="caste" id="caste" value="SC" <?php if ($candidate->caste == 'SC') {
                                                                                            echo "checked=checked";
                                                                                        }; ?>><span class="check-radio"></span> SC
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="caste" id="caste" value="ST" <?php if ($candidate->caste == 'ST') {
                                                                                            echo "checked=checked";
                                                                                        }; ?>><span class="check-radio"></span> ST
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="religion" name="religion" autocomplete="off" value="<?php echo $candidate->religion; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Disability Type<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="disability_type" name="disability_type" autocomplete="off" value="<?php echo $candidate->disability_type; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            ?>
                                <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/<?php echo $candidate->image; ?>" target="_blank">View</a>
                            <?php
                            } ?>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            ?>
                                <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/<?php echo $candidate->resume; ?>" target="_blank">View</a>
                            <?php
                            } ?>
                        </div>
                    </div>
                        ...
                        <div class="form-group">
                            ...
                            <select name="state" id="state" class="form-control">
                                ...
                                <option value="Karnataka" <?php
                                                            if ("Karnataka" == $candidate->state) {
                                                                echo "selected=selected";
                                                            } ?>>Karnataka</option>
                                <option value="Andhra Pradesh" <?php
                                                                if ("Andhra Pradesh" == $candidate->state) {
                                                                    echo "selected=selected";
                                                                } ?>>Andhra Pradesh</option>
                                <option value="Telangana" <?php
                                                            if ("Telangana" == $candidate->state) {
                                                                echo "selected=selected";
                                                            } ?>>Telangana</option>
                                <option value="Tamil Nadu" <?php
                                                            if ("Tamil Nadu" == $candidate->state) {
                                                                echo "selected=selected";
                                                            } ?>>Tamil Nadu</option>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status" value="Active" <?php if ($candidate->status == 'Active') {
                                                                                                    echo "checked=checked";
                                                                                                }; ?>><span class="check-radio"></span> Active
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status" value="Inactive" <?php if ($candidate->status == 'Inactive') {
                                                                                                    echo "checked=checked";
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            ?>
                                <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/<?php echo $candidate->sslc_marks_card; ?>" target="_blank">View</a>
                            <?php
                            } ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            ?>
                                <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/<?php echo $candidate->puc_marks_card; ?>" target="_blank">View</a>
                            <?php
                            } ?>
                        </div>
                    </div>
                ...
                <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <select name="be_type" id="be_type" class="form-control">
                                ...
                                <option value="BSC" <?php
                                                    if ("BSC" == $candidate->be_type) {
                                                        echo "selected=selected";
                                                    } ?>>BSC</option>
                                <option value="BBA" <?php
                                                    if ("BBA" == $candidate->be_type) {
                                                        echo "selected=selected";
                                                    } ?>>BBA</option>
                            </select>
                        </div>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            ?>
                                <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/<?php echo $candidate->be_marks_card; ?>" target="_blank">View</a>
                            <?php
                            } ?>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            ?>
                                <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/<?php echo $candidate->me_marks_card; ?>" target="_blank">View</a>
                            <?php
                            } ?>
                        </div>
                    </div>
                ...
                <div class="row">
                            ...
                            <select name="course_id" id="course_id" class="form-control" onchange="getSemestersById(this.value)">
                                ...
                                if (!empty($courseList)) {
                                    foreach ($courseList as $record) { ?>
                                        <option value="<?php echo $record->Id;  ?>" <?php
                                                                                    if ($record->Id == $candidate->course_id) {
                                                                                        echo "selected=selected";
                                                                                    } ?>>
                                            <?php echo $record->name; ?>
                                        </option>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="fee_paid" id="fee_paid" value="Yes" <?php if ($candidate->fee_paid == 'Yes') {
                                                                                            echo "checked=checked";
                                                                                        }; ?>><span class="check-radio"></span> Yes
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="fee_paid" id="fee_paid" value="No" <?php if ($candidate->fee_paid == 'No') {
                                                                                            echo "checked=checked";
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="hidden" class="form-control" id="fee_document_value" name="fee_document_value" value="<?php echo $candidate->fee_document; ?>">
                            <?php if ($candidate->fee_document) {
                            ?>
                                <a target="_blank" href="<?php echo BASE_PATH; ?>/assets/resources/<?php echo $candidate->fee_document; ?>" target="_blank">View</a>
                            <?php
                            } ?>
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="date" class="form-control" id="fee_date" name="fee_date" autocomplete="off" value="<?php echo $candidate->fee_date; ?>">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script>
            ...
            var job_role_id = "<?php echo $candidate->job_role_id ?>";
            var semester_id = "<?php echo $candidate->semester_id ?>";
