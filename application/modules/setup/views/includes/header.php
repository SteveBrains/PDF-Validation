    ...
    <div class="container-fluid">
      <div class="clearfix">
             <div class="navbar-header">
                 ...
                 <a class="navbar-brand" href="#" style="font-size:14px;">Centralized Student Placement Management </a>
             </div>
      ...
      <nav class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
         <ul class="nav navbar-nav main-nav">
          ...
          <li><a href="/placement/scheme/list">Placement</a></li>
          <li><a href="/examination/academicfacilitator/list">Examination</a></li>
        </ul>
      </nav>
    </div>
  </header>
