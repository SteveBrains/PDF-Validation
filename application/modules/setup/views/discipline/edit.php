                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo $disciplineInfo->name; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select class="form-control" id="course_id" name="course_id">
                                ...
                                <?php foreach ($courses as $row) { ?>
                                    <option value="<?php echo $row->id; ?>" <?php if ($disciplineInfo->course_id == $row->id) {
                                                                                echo "selected";
    ...
    $(document).ready(function() {
        $("#form_scheme").validate({
            ...
            messages: {
                ...
                course_id: {
                    required: "<p class='error-text'>Course Id reuired</p>",
                },
            },
            errorElement: "span",
