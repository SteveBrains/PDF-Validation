                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" value="<?php echo $semesterInfo->name; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Order <span class='error-text'>*</span></label>
                            <input type="number" class="form-control" id="order" name="order" value="<?php echo $semesterInfo->order; ?>">
                        </div>
                    </div>
                </div>
