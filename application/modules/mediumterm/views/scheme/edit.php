                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" name="name" autocomplete="off" required value="<?php echo $scheme->name; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Code<span class='error-text'>*</span></label>
                            <input type="text" class="form-control" id="code" name="code" autocomplete="off" value="<?php echo $scheme->code; ?>">
                        </div>
                    </div>
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <select name="training_center_id" id="training_center_id" class="form-control">
                                ...
                                if (!empty($tcList)) {
                                    foreach ($tcList as $record) { ?>
                                        <option value="<?php echo $record->Id;  ?>" <?php if ($record->Id == $scheme->training_center_id) {
                                                                                        echo "selected";
                                                                                    } ?>>
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status" value="Active" <?php if ($scheme->status == 'Active') {
                                                                                                    echo "checked=checked";
                                                                                                }; ?>><span class="check-radio"></span> Active
                            </label>
                            <label class="radio-inline">
                                <input type="radio" name="status" id="status" value="Inactive" <?php if ($scheme->status == 'Inactive') {
                                                                                                    echo "checked=checked";
                                                                                                }; ?>>
