    ...
    <form id="form_academic_year" action="" method="post" enctype="multipart/form-data">
      ...
      <div class="button-block clearfix">
        <div class="bttn-group">
          <a href="/application/studentapplication/approve1/<?php echo $application->id; ?>"><button type="button" class="btn btn-primary btn-lg">Approve</button></a>
          <a href="/application/studentapplication/reject1/<?php echo $application->id; ?>"><button type="button" class="btn btn-primary btn-lg">Reject</button></a>
          <a href="../list1" class="btn btn-link">Cancel</a>
        </div>
      </div>
    </form>
