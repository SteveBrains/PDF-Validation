        ...
        <div class=" col-md-12 col-lg-12">
          ...
          <form id="form_main" action="" method="post" enctype="multipart/form-data">
            <div class="form-container">
              <h4 class="form-group-title">Job Details</h4>
              <div class="row">
                <div class="col-sm-3">
                  <div class="form-group">
                    <label>Name :</label>
                    <label><b><?php echo $job->title; ?></b></label>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <label>Code :</label>
                    <label><b><?php echo $job->code; ?></b></label>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <label>Openings :</label>
                    <label><b><?php echo $job->openings; ?></b></label>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <label>Skills :</label>
                    <label><b><?php echo $job->skills; ?></b></label>
                  </div>
                </div>
                <div class="col-sm-3">
                  <div class="form-group">
                    <label>Company :</label>
                    <label><b><?php echo $job->company_name; ?></b></label>
                  </div>
                </div>
              </div>
            </div>
